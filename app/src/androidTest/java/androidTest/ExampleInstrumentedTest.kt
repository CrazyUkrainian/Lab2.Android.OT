...
class ExampleInstrumentedTest {
    ...
    fun testUserInfoDisplay() {
        ...
        val user = androidTest.OT.data.model.User("1", "John Doe", "john@example.com", "123-456-7890")

        composeTestRule.setContent {
            MyApplicationTheme {
                androidTest.OT.ui.components.UserInfo(user = user)
            }
        }
    ...
    fun testShiftListDisplay() {
        ...
        val shifts = listOf(
            androidTest.OT.data.model.Shift("1", "1", 1696523400, 1696531200),
            androidTest.OT.data.model.Shift("2", "1", 1696609800, 1696617600)
        )

        composeTestRule.setContent {
            MyApplicationTheme {
                androidTest.OT.ui.components.ShiftList(shifts = shifts)
            }
        }
